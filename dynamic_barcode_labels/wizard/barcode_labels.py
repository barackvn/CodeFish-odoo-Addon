    ...
    def print_report(self):
        ...
        datas = {
                 ...
                 'form': {
                    ...
                    #actually this want to print
                    'company_name': config_rec.company_name or '',
                    'product_name': config_rec.product_name,
                    'product_desc': config_rec.product_desc or '',
                    'revision': config_rec.revision or '',
                    'company_name_size': config_rec.company_name_size or 10,
                    'product_name_size': config_rec.product_name_size or 10,
                    'product_desc_size': config_rec.product_desc_size or 10,
                    'revision_size': config_rec.revision_size or 10,

                    'product_code': config_rec.product_code or '',
                    'price_display': config_rec.price_display,
                    'product_variant': config_rec.product_variant,
                    'product_code_size': config_rec.product_code_size or 10,
                    'price_display_size': config_rec.price_display_size or 10,
                    'product_variant_size': config_rec.product_variant_size or 10,

                    'lot': config_rec.lot,
                    #'default_qty_labels': config_rec.default_qty_labels or 'order_qty',
